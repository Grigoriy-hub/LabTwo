...
public class FunctionIOController {
    ...
    public ResponseEntity<FunctionDTO> input(@RequestParam("file") MultipartFile file) {
        try {
            ...
            FunctionDTO savedDto = mathFunctionService.createAndSaveMathFunctionEntity(deserializedFunction).getBody();
    ...
    public ResponseEntity<FunctionDTO> inputJson(@RequestParam("file") MultipartFile file) {
        try {
    ...
    public ResponseEntity<FunctionDTO> inputXml(@RequestParam("file") MultipartFile file) {
        try {
